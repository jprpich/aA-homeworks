...
# has three boxes of corgi snacks
# 
class SnackBox
  SNACK_BOX_DATA = {
    1 => {
...
# serves as an interface with our database
# must countain a reference to the database(an instace of SnackBox) and its box_id
# within the database. 

# We should be able to call bone, kibble, or treat on any instance of CorgiSnacks 
# and get back a statement of the info and tastiness level of that snack.
class CorgiSnacks
